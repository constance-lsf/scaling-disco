...
Project.create!(
  ...
  long_description: 'A social media built with Ruby on Rails and JavaScript, in a team of 4. Users can create accounts, add cultural events, post reviews about their last activity, saved some activities with a bookmark and follow other users.',
  my_role: 'I worked on the back-end, the front-end, and the database.',
  skill: 'Ruby on Rails, JavaScript',
...
Project.create!(
  ...
  date: '26-02-2024',
  duration: '1 week',
  description: 'A platform built with Ruby on Rails and Javascript in a team of 4. Users can create accounts, add their own activities called "wonders", and book some wonders.',
  long_description: 'A platform built with Ruby on Rails and Javascript in a team of 4. Users can create accounts, add their own activities called "wonders", and book some wonders.',
  my_role: 'I worked on the back-end, the front-end, and the database.',
  skill: 'Ruby on Rails, JavaScript',
